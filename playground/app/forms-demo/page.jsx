  ...
  return (
    <div className="max-w-4xl mx-auto space-y-12 pb-24">
      <header className="border-b border-slate-800 pb-6">
        <h1 className="text-3xl font-bold text-white tracking-tight">Web App Framework Forms Demo</h1>
        <p className="text-slate-400 mt-2">
          Showcasing a modular approach to form management using <code className="text-blue-400 bg-blue-500/10 px-1 rounded">web-forms</code>
      ...
      <section className="bg-slate-900/50 p-6 rounded-2xl border border-slate-800">
        ...
        <p className="text-sm text-slate-400 leading-relaxed">
          In Web App Framework, every capitalized component (like <code className="text-slate-300">BasicForm</code>) is compiled

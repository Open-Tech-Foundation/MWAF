import { onMount as _onMount, onCleanup as _onCleanup, setProperty as _setProperty, renderDynamic as _renderDynamic } from "@opentf/web";
export function render(root, props) {
  ...
  const rootElement = (() => {
    ...
    _setProperty(el5, "className", "font-mono bg-gray-200 px-1");
